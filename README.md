...
I build secure, scalable, and high-performance web applications using **Laravel**, **CodeIgniter**, **PHP**, and **MySQL**. I help businesses automate workflows, build REST APIs, and develop custom web applications from scratch.
